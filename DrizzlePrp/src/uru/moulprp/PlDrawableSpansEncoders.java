...
public class PlDrawableSpansEncoders
{
    ...
    public static class DecompressedPotsVertices
    {
        ...
        public DecompressedPotsVertices(byte[] rawdata, byte fformat2, int rawdataversion, int count2)
        {
            ...
            PlDrawableSpansEncoders.rundataElement[] ws = new PlDrawableSpansEncoders.rundataElement[B];
            for(int i=0;i<B;i++) ws[i] = new PlDrawableSpansEncoders.rundataElement();
            ...
            PlDrawableSpansEncoders.rundataElement[][] uvs = new PlDrawableSpansEncoders.rundataElement[C][3];
            for(int i=0;i<C;i++)
            {
