...
public class fixCraters
{
    public static void fixCraters(prpfile prp, String agename, String pagename, String outfolder, Pageid pid)
    {
        ...
        PrpRootObject sn = automation.hackFactory.createSceneNode(agename+"_"+pagename, pid);
        PrpRootObject so = automation.hackFactory.createSceneObject(sn, pagename+"_so", pid);
